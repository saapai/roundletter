...
/* ────────────────────────────────────────────────────────────
   /arc — the ghost town → let down scroll arc (moved off /).
   kept as a separate route so the home can open on its new
   hook (magnolia → jimmy cooks) and the cinematic descent is
   still reachable as the "for later" version.
   ──────────────────────────────────────────────────────────── */
      ...
      <section className="arc-let-down">
        ...
        <nav className="arc-transit" aria-label="site navigation">
          ...
          <ul className="arc-transit-list">
            <li><Link href="/">home · apparatus</Link><span>on time</span></li>
