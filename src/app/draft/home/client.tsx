...
const CSS = `
  ...
  .R-party-hero {
    ...
    background:
      ...
      radial-gradient(ellipse 60% 50% at 10% 8%, rgba(40,22,38,0.22) 0%, transparent 100%),
      radial-gradient(ellipse 50% 40% at 50% 45%, rgba(229,221,210,0.12) 0%, transparent 100%),
      linear-gradient(
        160deg,
        #F4EFE6  0%,
        #E5DDD2  5%,
