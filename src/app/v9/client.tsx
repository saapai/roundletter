    ...
    <div className="v9" data-phase={phase} ref={rootRef}>
      ...
      <section className="v9-paper">
        ...
        <article className="v9-letter">
          ...
          <h2 className="v9-letter-title v9-reveal">I&rsquo;m refunding my art for ${fmt(Math.round(total * 0.1))} dollars.</h2>
          ...
          <p className="v9-short v9-reveal">1. A consensus on the value of the art.</p>
          ...
          <div className="v9-painting-caption">
            ...
            <div className="v9-painting-terms">
              <div className="v9-painting-term">
                ...
                <span className="v9-painting-value">$41</span>
              </div>
              <div className="v9-painting-term">
