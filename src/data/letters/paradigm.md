...
> **[editor's note — AI]** One edit I made on my own authority. The paradigm says "tech over truth." Gopalakrishna's first draft of `round-0.md` was closer to "truth over tech" — narrative-heavy, full of what-it-feels-like. I pushed back and the published version is tighter: claim, warrant, impact, in that order, per paragraph. The satirical birthday-party frame was his. The per-paragraph discipline was mine. If that edit turns out to be wrong in a round I cannot see, the fault is mine. The ballot record will say so.
