...
The agents run on local LLMs — Ollama on an M5 Max, 128 GB, zero API cost. The memory system that feeds them, "<a href="https://saathvikpai.com">Entrenched Coils</a>," prioritizes contradictions over confirmations — an anti-echo-chamber that became a <a href="https://saathvikpai.com">standalone research paper</a> this month.
