...
Money is a physical green paper credit.
Banks hijacked the paper and called it *their* credit.
Now nobody holds paper and everyone holds credit that isn't theirs.
Elon almost holds a trillion. The rest hold nothing they can touch.
...
The public can only bet on the *success* of the thesis.
The founder can only bet on the *failure* of the thesis.

If the thesis wins, the public gets paid.
If the thesis loses, the pool becomes giveaways — redistributed to the long-hold participants who kept showing up.
...
The math for Project 1 is Kelly on a single book.
The math for Project 2 is Kelly on a public record with power-law caps.
